...
<footer class="pie-pagina" style="background-color: darkslategrey;">
        <div class="grupo-1" >
            <div class="box" style="background-color: transparent;">
                <figure>
                <a href="#">
                <img src="../empleados/imagenes/CineGalaxyLogoNegro.png" alt="Logo" height="">
        ...
        <div class="grupo-2" style="background-color: olivedrab;">
