...
<main class="contenedor seleccion">
    ...
    <center><h1 style="color: white;">Lista de empleados</h1></center>
    <br><br>
        <table class="table table-dark table-striped">
            ...
            <tbody>
                <?php
                    $consql="Select * from empleados where estado_empleado='activo'";
                ...
                ?>
                    <tr>
                        ...
                        <td> <?php echo $reg['telefono_empleado']; ?> </td>
                        <td> <img src="imagenes/<?php echo $reg['imagen_empleado']; ?>" style="width: 100px; height: 100px; object-fit: cover;"> </td>
                        
                        <td>
                            <form method="post" action="borrar.php" style="display:inline;">
                                <input type="hidden" name="id_empleado" value="<?php echo $reg['ID_empleado']; ?>">
                        ...
                        <td>
                            <form method="get" action="actualizar.php" style="display:inline;">
                                <input type="hidden" name="cod" value="<?php echo $reg['ID_empleado']; ?>">
        ...
        <br>
        <a href="/CineGalaxy/admin/empleados/crear.php" class="button btn btn-light"style="margin-left: 50px;">Nuevo vendedor</a>
    <br><br><br>
</main>
<!-- ███████████████████████████████████████████████████████████████ -->
