...
<main class="contenedor seleccion">
    ...
    <center><h1 style="color: white;">Lista de Peliculas</h1></center>
    <br><br>
        <table class="table table-dark table-striped">
            ...
            <tbody>
                <?php
                    $consql="Select * from peliculas where estado_pelicula='activo'";
                    $resultado=mysqli_query($db,$consql);
                    while($reg=$resultado->fetch_assoc())
                    {
                    ?>
                    <tr>
                        <td> <?php echo $reg['ID_pelicula']; ?> </td>
                        <td> <?php echo $reg['nombre_pelicula']; ?> </td>
                        <td> <?php echo $reg['precio_pelicula']; ?> </td>
                        <td> <?php echo $reg['genero_pelicula']; ?> </td>
                        <!-- <td> <?php //*echo $reg['horario_pelicula']; **/?> </td> -->
                        <td> <img src="imagenes/<?php echo $reg['imagen_pelicula']; ?>" style="width: 100px; height: 100px; object-fit: cover;"> </td>
                        
                        <td>
                            <form method="post" action="borrarp.php" style="display:inline;">
                                <input type="hidden" name="id_pelicula" value="<?php echo $reg['ID_pelicula']; ?>">
                                <button type="submit" class="btn btn-danger">Eliminar</button>
                            </form>
                        </td>

                        <td>
                            <form method="get" action="actualizarp.php" style="display:inline;">
                                <input type="hidden" name="id_pelicula" value="<?php echo $reg['ID_pelicula']; ?>">
        ...
        <br>
        <a href="/CineGalaxy/admin/pelicula/crearp.php" class="button btn btn-light"style="margin-left: 50px;">Nueva Pelicula</a>
    <br><br><br>
</main>
